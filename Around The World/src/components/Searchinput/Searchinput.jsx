...
const filteredCountries =!searchTerm || searchTerm ===""? countriesList :
countriesList.filter(country=>country.name.official.toLowerCase().includes(searchTerm.toLowerCase()))
